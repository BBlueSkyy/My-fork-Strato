...
namespace skyline::gpu {
    ...
    ShaderManager::ShaderManager(const DeviceState &state, GPU &gpu, std::string_view replacementDir, std::string_view dumpDir) : gpu{gpu}, dumpPath{dumpDir} {
        ...
        profile = Shader::Profile{
            ...
            .support_storage_int8 = traits.supportsStorageBuffer8BitAccess,
            .support_storage_int16 = traits.supportsStorageBuffer16BitAccess,
            .support_variable_pointers_storage_buffer = traits.supportsVariablePointersStorageBuffer,
            .support_int64 = traits.supportsInt64,
