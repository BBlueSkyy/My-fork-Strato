...
namespace skyline {
    ...
    namespace vfs {
        ...
        // CRITICAL FIX: The 4-byte `_pad0_` must be present at the start of the bucket.
        // Removing this erroneously shifted the header and caused physicalSize to be read as 0xFFFFFFFF.
