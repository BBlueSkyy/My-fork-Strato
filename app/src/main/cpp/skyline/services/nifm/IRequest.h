...
namespace skyline::service::nifm {
    ...
    class IRequest : public BaseService {
      private:
        std::shared_ptr<type::KEvent> event0; //!< Signals when RequestState changes
        std::shared_ptr<type::KEvent> event1; //!< Secondary request-change event
        RequestState requestState{RequestState::Free};
