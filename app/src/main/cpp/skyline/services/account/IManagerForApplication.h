    ...
    class IManagerForApplication : public BaseService {
      ...
      public:
        ...
        */
        ...
        /**
         * @brief Returns the cached Nintendo Account resource for this user
         * @url https://switchbrew.org/wiki/Account_services#GetNintendoAccountUserResourceCacheForApplication
         */
