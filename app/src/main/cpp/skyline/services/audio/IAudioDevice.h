...
namespace skyline::service::audio {
    ...
    class IAudioDevice : public BaseService {
      ...
      public:
        ...
        Result GetAudioSystemMasterVolumeSetting(type::KSession &session, ipc::IpcRequest &request, ipc::IpcResponse &response);
        ...
        SERVICE_DECL(
            ...
            SFUNC(0x7, IAudioDevice, GetAudioSystemMasterVolumeSetting),
            SFUNC(0x8, IAudioDevice, SetAudioDeviceOutputVolume),
            SFUNC(0x9, IAudioDevice, GetAudioDeviceOutputVolume),
