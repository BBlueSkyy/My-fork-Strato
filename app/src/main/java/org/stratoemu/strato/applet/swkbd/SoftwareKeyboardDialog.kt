...
class SoftwareKeyboardDialog : DialogFragment() {
    ...
    private var futureResult : FutureTask<SoftwareKeyboardResult> = FutureTask {
    ...
    override fun onCreateView(inflater : LayoutInflater, container : ViewGroup?, savedInstanceState : Bundle?) =
        if (savedInstanceState?.getBoolean("stopped") != true) KeyboardDialogBinding.inflate(inflater).also { binding = it }.root else null
